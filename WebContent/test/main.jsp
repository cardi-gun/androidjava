...
<a href="userPage.jsp?id=<%-- <%=userVO.getId()%> --%>"><button type="submit" id="user">유저페이지</button></a>
<a href="teacherPage.jsp?id=<%-- <%=teacherVO.getId()%> --%>"><button type="submit" id="teacher">강사페이지</button></a>
</body>
</html>